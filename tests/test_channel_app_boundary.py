...
def test_channel_share_export_failure_and_explicit_clear_zero_full_buffer(tmp_path):
    ...
    harness.write_text(
        ...
        "#define ESP_ERR_INVALID_ARG 0x102\n"
        "#define ESP_ERR_NOT_SUPPORTED 0x106\n"
        "#define D1L_RELEASE_FEATURE_ADVANCED_QR_EMOJI 22\n"
        "static bool profile_available = true;\n"
        "static bool channel_share_available = true;\n"
        "static bool multi_channel_management_available(void)\n"
        "{ return profile_available; }\n"
        "static bool d1l_release_feature_available(int feature)\n"
        "{ return feature == D1L_RELEASE_FEATURE_ADVANCED_QR_EMOJI &&\n"
        "         channel_share_available; }\n"
        ...
        " profile_available = true; channel_share_available = false;\n"
        " memset(buffer, 'X', sizeof(buffer));\n"
        " if (d1l_app_model_export_channel_share_uri(7, buffer, sizeof(buffer))\n"
        "     != ESP_ERR_NOT_SUPPORTED || buffer[0] != 'X') return 6;\n"
        " return 0;\n"
        "}\n",
        encoding="utf-8",
    )
