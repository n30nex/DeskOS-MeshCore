...
int main(void)
{
    ...
    assert(d1l_ui_screen_available(D1L_UI_SCREEN_MAP));
    ...
    assert_surface("storage-card", "storage_card",
                   D1L_UI_SCREEN_SETTINGS, true);
    assert_surface("wifi", "wifi", D1L_UI_SCREEN_SETTINGS, true);
    assert_surface("contact-route", "contact_route",
                   D1L_UI_SCREEN_NODES, true);
    assert_surface("mesh-roles", "mesh_roles",
                   D1L_UI_SCREEN_PACKETS, true);
    assert_surface("map-location", "map_location",
                   D1L_UI_SCREEN_MAP, true);
