...
typedef struct {
    ...
    uint32_t radio_direct_tx;
    uint32_t radio_flood_rx;
    uint32_t radio_direct_rx;
    uint64_t radio_tx_airtime_ms;
    uint64_t radio_rx_airtime_ms;
    int16_t radio_noise_floor_dbm;
    int16_t radio_last_rssi_dbm;
    int8_t radio_last_snr_quarter_db;
    bool radio_signal_valid;
    bool radio_noise_valid;
