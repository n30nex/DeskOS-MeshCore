...
- Channels is list-first: Public, #bot, and #test are ordinary channel rows with
  selection and unread state, while DMs opens direct conversations. Opening
